...
### Part1 Development Architecture

- Linux system (NixOS Linux & Arch Linux machines where used)
    - python 3.12
        - uv (package manager and virtual env handler)
            - gradio (optional for GUI)

for producibility a nix-shell exist
...
also a requirement.txt for python virtual environments

### Part2 Development Architecture


![diagram](SystemArch.svg)